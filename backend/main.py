...
from app.api.endpoints import auth, user, cards, transactions, savings, statistics, exchange, bot as bot_api
...
app.include_router(exchange.router, prefix=f"{settings.API_V1_STR}/exchange-rates", tags=["exchange"])
